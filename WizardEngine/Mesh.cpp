...
{
	CreateBuffers(a_pVertex, a_nVertexCount, a_pIndices, a_nIndexCount, a_pDevice);
}

Mesh::Mesh(char * a_cFileName, ID3D11Device * a_pDevice)
{
	// File input object
	std::ifstream obj(a_cFileName);
...
void Mesh::CreateBuffers(Vertex * a_pVertex, int a_nVertexCount, UINT * a_pIndices, int a_nIndexCount, ID3D11Device * a_pDevice)
{
	// Calculate the tangents before copying to buffer
	CalculateTangents(a_pVertex, a_nVertexCount, a_pIndices, a_nIndexCount);
